...
import { uploadPost } from "../actions/postUpload";
  ...
  onSubmit = e => {
    ...
    if (address) {
      geocodeByAddress(address, (err, { lat, lng }, placeId) => {
        ...
        this.props
          .uploadPost(
            { caption, filter, address, lat, lng, placeId, filterStyle },
            files[0]
          )
      ...
      this.props
        .uploadPost({ caption, filter, filterStyle }, files[0])
        .then(() => this.props.afterSubmit());
    }
  };
        ...
        <div className="NewPostBoard__tab-panel">
          <div className="NewPostBoard__slider-item">
            <label className="NewPostBoard__slider-label">
              <i
                className="fa fa-sun-o NewPostBoard__slider-icon"
                aria-hidden="true"
              />{" "}
              Brightness
            </label>
          ...
          <div className="NewPostBoard__slider-item">
            <label className="NewPostBoard__slider-label">
              <i
                className="fa fa-adjust NewPostBoard__slider-icon"
                aria-hidden="true"
              />{" "}
              Contrast
            </label>
          ...
          <div className="NewPostBoard__slider-item">
            <label className="NewPostBoard__slider-label">
              <i
                className="fa fa-tint NewPostBoard__slider-icon"
                aria-hidden="true"
              />{" "}
              Saturation
            </label>
          ...
          {filters.map((f, idx) => (
            <FilterButton
              ...
              onMouseDown={() =>
                this.setState({
                  filter: f.className,
                  filterStyle: filterStyles[f.className]
                })
              }
              imagePath={preview}
              filter={f.className}
          ...
          <PlacesAutocomplete
            ...
            classNames={{
              ...
              autocompleteContainer:
                "NewPostBoard__place-autocomplete-container"
            }}
          />
          <div>
            <label>Caption</label>
